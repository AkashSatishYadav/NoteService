...
namespace NoteService.Services
{
    public class ServiceManager : IServiceManager
    {
        ...
        public ServiceManager(IRepositoryManager repository, IMapper mapper, IOutboxRepository outboxRepository)
        {
               _userNoteService =new Lazy<IUserNoteService>(()=> new  UserNoteService(repository, mapper, outboxRepository));
        }
    }
}
